...
Source0  : https://files.pythonhosted.org/packages/d8/cd/3a242a90939cca779d4370e3c6028a262c440ccc92e6f6104e129556e51d/glyphslib-6.7.1.tar.gz
...
%prep
%setup -q -n glyphslib-6.7.1
cd %{_builddir}/glyphslib-6.7.1
pushd ..
cp -a glyphslib-6.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714402596
