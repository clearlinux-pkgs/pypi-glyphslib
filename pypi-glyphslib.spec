...
Source0  : https://files.pythonhosted.org/packages/26/53/572facab0b0ba3a4a39a30f709414d61cf60f8a92c3ce53a4d24b9fa1623/glyphsLib-6.6.6.tar.gz
...
%prep
%setup -q -n glyphsLib-6.6.6
cd %{_builddir}/glyphsLib-6.6.6
pushd ..
cp -a glyphsLib-6.6.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709230717
